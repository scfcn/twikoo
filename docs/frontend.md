...
``` html
<div id="tcomment"></div>
<script src="https://cdn.jsdelivr.net/npm/twikoo@1.7.0/dist/twikoo.min.js"></script>
<script>
twikoo.init({
...
* `https://s4.zstatic.net/npm/twikoo@1.7.0/dist/twikoo.min.js`

#### 推荐在全球使用

* `https://cdn.jsdelivr.net/npm/twikoo@1.7.0/dist/twikoo.min.js`
